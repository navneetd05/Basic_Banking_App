...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    private com.navneet.bankingsystem.ViewHolder.ClickListener mClickListener;
    public interface  ClickListener{
        void onItemClick(View view, int position);
    }

    public void setOnClickListener(com.navneet.bankingsystem.ViewHolder.ClickListener clickListener){
